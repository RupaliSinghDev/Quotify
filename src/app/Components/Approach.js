...
const Approach = () => {
  ...
  return (
    <div className='bg-[#837b9e]'>
      <motion.h1
        className='text-4xl lg:text-6xl bg-[#837b9e]font-bold text-center mt-20 mb-8 font-serif tracking-tighter'
        initial='hidden'
        animate={controls}
      ...
      <div
        ref={ref}
        className='relative w-full py-20 bg-[#837b9e] text-black overflow-x-hidden' // Ensure no horizontal overflow
      >
        <motion.div
        ...
        >
          ...
          <motion.div
            className='bg-[#837b9e] p-0  mx-auto lg:mr-12 flex flex-col items-center'
            initial='hidden'
            animate={controls}
