...
const PeaceandSolitude = () => {
    ...
    const fetchQuote = () => {
        setLoading(true);
        fetch("https://quotify-api.vercel.app/quote/random/hindi/peace and solitude")
            .then(res => {
                if (!res.ok) {
    ...
    return (
        <div className="flex justify-center items-center h-screen" style={{backgroundImage: 'url(/Peace.jpg)', backgroundSize: 'cover'}}>
...
export default PeaceandSolitude;
