...
const Success = () => {
    ...
    const fetchQuote = () => {
        setLoading(true);
        fetch("https://quotify-api.vercel.app/quote/random/hindi/success")
            .then(res => {
                if (!res.ok) {
    ...
    return (
        <div className="flex justify-center items-center h-screen" style={{backgroundImage: 'url(/Successs.jpg)', backgroundSize: 'cover'}}>
