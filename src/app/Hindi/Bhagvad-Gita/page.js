...
const BhagvadGita = () => {
    const [content, setContent] = useState("नादत्ते कस्यचित्पापं न चैव सुकृतं विभु:। अज्ञानेनावृतं ज्ञानं तेन मुह्यन्ति जन्तव:॥");
    const [author, setAuthor] = useState("Chapter 5, Verse 15");
    ...
    const fetchQuote = () => {
        setLoading(true);
        fetch("https://quotify-api.vercel.app/quote/random/hindi/bhagavad gita")
            .then(res => {
                if (!res.ok) {
    ...
    return (
        <div className="flex justify-center items-center h-screen" style={{backgroundImage: 'url(/Bhagvad-Gita.jpg)', backgroundSize: 'cover'}}>
