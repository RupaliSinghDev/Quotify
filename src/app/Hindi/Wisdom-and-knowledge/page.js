...
const WisdomandKnowledge = () => {
    const [content, setContent] = useState("जीवन की सबसे बड़ी कल्पना करो और फिर उसे हासिल करने के लिए पूरी ईमानदारी और उत्साह से काम करो।");
    const [author, setAuthor] = useState("स्वामी विवेकानंद");
    ...
    const fetchQuote = () => {
        setLoading(true);
        fetch("https://quotify-api.vercel.app/quote/random/hindi/wisdom and knowledge")
            .then(res => {
                if (!res.ok) {
    ...
    return (
        <div className="flex justify-center items-center h-screen" style={{backgroundImage: 'url(/Wisdom.jpg)', backgroundSize: 'cover'}}>
...
export default WisdomandKnowledge;
